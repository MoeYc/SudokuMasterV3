...
import { disable, enable, getPage } from '@/services/UserService';
import { CheckCircleTwoTone, CloseCircleTwoTone } from '@ant-design/icons';
import { message, Pagination, Popconfirm, Spin, Table } from 'antd';
    ...
    },
    {
      ...
      render: (enabled, record) => (
        <Popconfirm
          ...
          cancelText="否"
        >
          {enabled ? <CheckCircleTwoTone twoToneColor="green" /> : <CloseCircleTwoTone />}
        </Popconfirm>
      ),
      filters: [
        { text: '已激活', value: true },
