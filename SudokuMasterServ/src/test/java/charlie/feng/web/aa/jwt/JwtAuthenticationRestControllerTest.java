...
public class JwtAuthenticationRestControllerTest {
    ...
    public void setUp() throws LiquibaseException {
        ...
        mvc = MockMvcBuilders.standaloneSetup(controller)
                ...
                .addPlaceholderValue("jwt.path.refresh", "/api/login/refresh")
                .addPlaceholderValue("jwt.path.authentication", "/api/login/login")
                .addPlaceholderValue("jwt.path.logoff", "/api/login/logoff")
                .addPlaceholderValue("jwt.path.currentUser", "/api/login/currentUser")
                ...
                .addPlaceholderValue("charlie.feng.aa.apiPrefix", "/api")
                .build();
    ...
    public void login() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/login/login")
