...
@SpringBootTest(classes = {SudokumasterservApplication.class, LiquibaseTestConfig.class})
@ActiveProfiles("dev")
...
public class UserControllerTest {
    ...
    public void setUp() throws LiquibaseException {
        mvc = MockMvcBuilders.standaloneSetup(userController).setControllerAdvice(new GlobalControllerExceptionHandler()).addPlaceholderValue("charlie.feng.aa.apiPrefix", "/api").build();
    ...
    public void enableDisable() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/user/enable")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(content))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON_VALUE))
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/user/disable")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(content))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void findByUserName() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/api/user/username/charlie"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.length()").value(6))
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/user/username/angela"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.length()").value(6))
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/user/username/warren"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.length()").value(6))
    ...
    public void findByUserNameViaAdmin() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/user/username/noneExistingUser"))
                .andExpect(status().isNotFound());
    }
    ...
    public void findByUserNameViaUser() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/user/username/mockuser01"))
                .andExpect(status().isUnauthorized());
