...
public class GridController {
    ...
    @ResponseBody
    @GetMapping(value = "${charlie.feng.aa.apiPrefix}/grids",
    ...
    @ResponseBody
    @PutMapping(value = "${charlie.feng.aa.apiPrefix}/grid/{id}",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseBody
    @RequestMapping(value = "${charlie.feng.aa.apiPrefix}/grid/{id}/resolve",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseBody
    @GetMapping(value = "${charlie.feng.aa.apiPrefix}/positions",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseBody
    @PutMapping(value = "${charlie.feng.aa.apiPrefix}/position/{gridId}/{positionCode}",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseBody
    @RequestMapping(value = "${charlie.feng.aa.apiPrefix}/position/{gridId}/{positionCode}/resolve",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseBody
    @RequestMapping(value = "${charlie.feng.aa.apiPrefix}/position/{gridId}/{positionCode}/validate",
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
